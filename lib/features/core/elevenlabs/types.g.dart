...
TextToSpeechRequest _$TextToSpeechRequestFromJson(Map<String, dynamic> json) => TextToSpeechRequest(
      ...
      voiceSettings: json['voice_settings'] == null ? null : VoiceSettings.fromJson(json['voice_settings'] as Map<String, dynamic>),
    );
...
FineTuning _$FineTuningFromJson(Map<String, dynamic> json) => FineTuning(
      ...
      verificationAttempts: (json['verification_attempts'] as List<dynamic>?)?.map((e) => VerificationAttempt.fromJson(e as Map<String, dynamic>)).toList(),
      verificationAttemptsCount: (json['verification_attempts_count'] as num).toInt(),
...
HistoryItem _$HistoryItemFromJson(Map<String, dynamic> json) => HistoryItem(
      characterCountChangeFrom: (json['character_count_change_from'] as num).toInt(),
...
DownloadHistoryItemsRequest _$DownloadHistoryItemsRequestFromJson(Map<String, dynamic> json) => DownloadHistoryItemsRequest(
...
SubscriptionInfo _$SubscriptionInfoFromJson(Map<String, dynamic> json) => SubscriptionInfo(
      ...
      nextCharacterCountResetUnix: (json['next_character_count_reset_unix'] as num).toInt(),
