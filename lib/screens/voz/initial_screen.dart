    ...
    return Container(
      ...
      child: Column(
        children: [
          Expanded(
            flex: 4,
            child: LolaServerMessagePad(stream: _serviceStream, scale: widget._scale, maxLines: 10),
          ),
          Expanded(
            flex: 1,
            child: Column(
                          ...
                          child: ActionButton(
                            ...
                            onPressed: () async {
                              ...
                              await switch (_initialCtrl.currentState) {
                                InitialState.idle => _initialCtrl.loadSummary(debug: _debug),
                                InitialState.loadingReminders => navigator.popAndPushNamed('/voz'),
                                InitialState.loadingSummary => _initialCtrl.loadReminders(debug: _debug)
                              };
                            },
                          ),
                        ),
